#!/bin/bash
#SBATCH --job-name=train_davis_p3
...
#SBATCH --output=logs/slurm/davis_p3_train_%j.out

# ============================================================
#  DAVIS Phase 3 Training — Fine-tuning from BL30K
#
#  Branches from best_slim_v2_phase2_bl30k-v2.ckpt (job 65781828).
#  Parallel to LVOS and YouTube-VOS Phase 3 branches.
#
#  Submit:
#    sbatch scripts/slurm_train_davis_phase3_lustre.sh
# ============================================================
...
python train.py \
    ...
    +experiment=mv2_ssm_mem_phase3_davis \
